 ...
 *
 * v1.1.1 修复：applyDayNight() 内部在 API 11+ 仍调用 recreate()，并未真正消除频闪。
 * 恢复 setDefaultNightMode() + 由调用方手动 recreate() 的方案，
 * 搭配 SettingsFragment 中的 themeChanging 标志防止 Spinner 重复触发。
 */
object ThemeManager {
